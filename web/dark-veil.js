// React Bits - DarkVeil Component (@react-bits/DarkVeil-JS-CSS)
// Converted to Vanilla ES Module with OGL
import { Renderer, Program, Mesh, Triangle, Vec2 } from './ogl.mjs';
...
export function initDarkVeil(container, options = {}) {
  ...
  const speed = options.speed !== undefined ? options.speed : 0.45;
